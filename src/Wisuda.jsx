...
function Wisuda(){
    ...
    return(
        ...
        <div className={`items-center flex flex-col justify-center ${climg?"opacity-100":"opacity-0 max-h-0 max-w-0 pointer-events-none"} transition-all duration-500 space-y-2`}>
        <img 
                src="https://picsum.photos/300" 
